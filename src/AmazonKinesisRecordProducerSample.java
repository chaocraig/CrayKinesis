...
public class AmazonKinesisRecordProducerSample {
     ...
     *      (/Users/cray/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    private static void init() throws Exception {
        /*
         * The ProfileCredentialsProvider will return your [cray]
         * credential profile by reading from the credentials file located at
         * (/Users/cray/.aws/credentials).
         */
        AWSCredentials credentials = null;
        try {
            credentials = new ProfileCredentialsProvider("cray").getCredentials();
        } catch (Exception e) {
            throw new AmazonClientException(
                    "Cannot load the credentials from the credential profiles file. " +
                    "Please make sure that your credentials file is at the correct " +
                    "location (/Users/cray/.aws/credentials), and is in valid format.",
                    e);
        }
